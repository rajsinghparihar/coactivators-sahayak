...
export function MessageItem({
    ...
    if (hasTimelineEvents) {
      return (
        <div className="flex items-start gap-3 max-w-[90%]">
          ...
          <div className="flex-1 bg-white border border-gray-200 rounded-2xl rounded-tl-sm p-4 shadow-lg">
            <ActivityTimeline
              processedEvents={messageEvents.get(message.id) || []}
              isLoading={isLoading}
              websiteCount={websiteCount}
  ...
  return (
    <div className="flex items-start gap-3 max-w-[90%]">
      ...
      <div className="flex-1 bg-white border border-gray-200 rounded-2xl rounded-tl-sm p-4 shadow-lg relative group">
        {/* Activity Timeline */}
