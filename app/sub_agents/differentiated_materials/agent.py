...
from . import prompt
from .sub_agents.grade_adapter import grade_adapter_agent
...
differentiated_materials_agent = LlmAgent(
    ...
    description=(
        ...
        - grade_adapter: simplifies the language and content for a given worksheet and adapts it to a grade level.
